...
void main() {
  ...
  // 반복적인 프로그래밍을 피하고 코드로 재사용할 수 있게 해줍니다.
  // 함수로 프로그래밍을 나누어 작성하면 모듈화가 되고 코드의 가독성이 좋아지며
  // 문제가 발생했을 때 손쉽게 유지보수 할 수 있습니다.
  ...
  // 변수에 익명 함수를 대입할 수도 있다. 이때 Function 타입을 사용합니다.
  ...
  // 익명함수와 람다식의 가장 큰 차이는 return 키워드를 적지 않아도 값이
  // 반환되지만 익명함수는 값을 반환하려면 return 키워드를 꼭 적어야 한다.
